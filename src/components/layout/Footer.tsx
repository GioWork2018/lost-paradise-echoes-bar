...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-night border-t border-rust/30 py-8 sm:py-10">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg sm:text-xl font-display mb-4">LOST PARADISE</h3>
            <p className="text-sm text-fog/80 mb-4 leading-relaxed">
          ...
          <div className="space-y-4 sm:space-y-2">
            <h4 className="text-base sm:text-lg font-mono uppercase tracking-wider mb-4">Info</h4>
          ...
          <div className="space-y-4 sm:space-y-2">
            <h4 className="text-base sm:text-lg font-mono uppercase tracking-wider mb-4">Contatti</h4>
        ...
        <div className="mt-8 sm:mt-10 pt-6 border-t border-fog/10 text-center">
          <p className="text-fog/60 text-sm px-4">
